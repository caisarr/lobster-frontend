...
st.write("\n")
st.subheader("Lobster ID adalah pemasok lobster premium yang berdedikasi untuk menyediakan lobster air tawar dan air laut dengan kualitas terbaik untuk pasar Indonesia.", anchor=False)
st.write(
    """
